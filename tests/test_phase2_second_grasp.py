...
def test_B_placement_is_deterministic_bounded_and_table_resting():
    cfg = load_configs()
    ...
    assert np.isclose(cylinder_lowest_point_z(first.position_m, first.quaternion, 0.025, 0.04), table_top)
